...
export default function ResetPassword() {
  ...
  return (
    <div className="rp-root">
      <style>{`
        .rp-root{min-height:100vh;min-height:100svh;background:#020307;color:#f0ece3;display:grid;grid-template-columns:.95fr 1.05fr;font-family:'Barlow',sans-serif;overflow:hidden;position:relative}
        ...
        .rp-success-title{font-family:'Bebas Neue',sans-serif;font-size:54px;line-height:.92;letter-spacing:-.5px;text-align:center;margin-bottom:14px}
