const EFFECTS = {
  ...
  fire: {
    css: () => `@keyframes fg{0%,100%{box-shadow:0 0 8px #ff5500aa,0 0 20px #ff550055}50%{box-shadow:0 0 16px #ff5500cc,0 0 32px #ff550077}}@keyframes fw{0%,100%{transform:scaleY(1)}50%{transform:scaleY(1.08)}}`,
    ...
    text: () => ({ background:"linear-gradient(90deg,#f5e03a,#ff5500)", backgroundClip:"text", WebkitBackgroundClip:"text", color:"transparent" }),
  ...
  sparkle: {
    css: () => `@keyframes sp{0%,100%{box-shadow:0 0 8px #f5e03a55,0 0 20px #ff550033}33%{box-shadow:0 0 12px #a78bfa55}66%{box-shadow:0 0 10px #f5e03a77}}@keyframes spr{from{transform:rotate(0)}to{transform:rotate(360deg)}}`,
    ...
    text: () => ({ background:"linear-gradient(90deg,#f5e03a,#ff5500,#f5e03a)", backgroundClip:"text", WebkitBackgroundClip:"text", color:"transparent" }),
    emoji: "spr 4s linear infinite",
  },
  rainbow: {
    css: () => `@keyframes rbf{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}@keyframes rbg{0%,100%{box-shadow:0 0 10px #f5e03a44}33%{box-shadow:0 0 10px #a78bfa44}66%{box-shadow:0 0 10px #22c55e44}}`,
    wrap: () => ({ background:"linear-gradient(270deg,#f5e03a22,#ff550022,#a78bfa22,#60a5fa22,#22c55e22,#f5e03a22)", backgroundSize:"400% 400%", animation:"rbf 4s ease infinite,rbg 3s ease-in-out infinite", border:"1.5px solid rgba(245,224,58,.3)" }),
    text: () => ({ background:"linear-gradient(90deg,#f5e03a,#ff5500,#a78bfa,#60a5fa,#22c55e)", backgroundClip:"text", WebkitBackgroundClip:"text", color:"transparent" }),
    emoji: "none",
  },
  glitch: {
...
const FALLBACK_BADGES = {
  badge_creator: { key:"badge_creator", name:"CREATOR", emoji:"⚡", rarity:"legendary", data:{ color:"#f5e03a", animated:true, effect:"lightning" } },
  ...
  badge_first:   { key:"badge_first",   name:"1er Envío",emoji:"🎯",rarity:"common",   data:{ color:"#f5e03a", animated:false                    } },
  ...
  badge_loyal:   { key:"badge_loyal",   name:"Leal",    emoji:"💛", rarity:"rare",     data:{ color:"#f5e03a", animated:false                    } },
};
