  ...
  return (
    <div ref={rootRef} className="eh-root">
      <style>{`
        ...
        .eh-root::after{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(245,224,58,.018) 1px,transparent 1px),linear-gradient(90deg,rgba(245,224,58,.018) 1px,transparent 1px);background-size:48px 48px;pointer-events:none;opacity:.7}
        .eh-watermark{position:absolute;right:-30px;bottom:-50px;font-family:'Bebas Neue',sans-serif;font-size:clamp(140px,18vw,260px);line-height:.78;letter-spacing:-6px;color:transparent;-webkit-text-stroke:1px rgba(245,224,58,.04);pointer-events:none;user-select:none;will-change:transform}
        .eh-glow{position:absolute;width:380px;height:380px;border-radius:50%;background:radial-gradient(circle,rgba(245,224,58,.05) 0%,transparent 70%);top:50%;left:-120px;transform:translateY(-50%);pointer-events:none;z-index:1}
        ...
        .eh-title em::after{content:'';position:absolute;left:0;right:0;bottom:6%;height:18%;background:rgba(245,224,58,.12);z-index:-1;transform:scaleX(0);transform-origin:left;animation:eh-hl 1.1s cubic-bezier(.2,.8,.2,1) .8s forwards}
        ...
        .eh-kpi:hover{background:rgba(245,224,58,.025)}
