  ...
  return (
    <>
      <style>{`
        ...
        .tb-role { font-family:'DM Mono',monospace; font-size:9px; letter-spacing:2px; text-transform:uppercase; padding:3px 9px; background:rgba(245,224,58,0.06); border:1px solid rgba(245,224,58,0.2); color:var(--brand-primary, #f5e03a); font-weight:500; }
        ...
        .tb-logout:hover { background:rgba(255,85,0,0.08); color:var(--brand-accent, #ff8c2a); border-color:rgba(255,85,0,0.25); }
                  ...
                  <div style={{overflowY:"auto",maxHeight:400}}>
                    ...
                    {notifs.map(n => {
                      ...
                      const ANN_CFG = {
                        ...
                        linea:   { emoji: "🌐", color: "var(--brand-primary, #f5e03a)", bg: "rgba(245,224,58,.1)", border: "rgba(245,224,58,.3)", label: "Líneas" },
                        ...
                        general: { emoji: "📢", color: "var(--brand-primary, #f5e03a)", bg: "rgba(245,224,58,.1)", border: "rgba(245,224,58,.3)", label: "Anuncio" },
                      };
