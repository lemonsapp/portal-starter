// client/src/data/lineDetails.js
//
...
export const lineDetails = {
  "linea-elite": {
    ...
    "features": [
      ...
      {
        "title": "EC predecible",
        "body": "Dosis exacta = EC exacta. Repetible riego tras riego, lote tras lote.",
        "emoji": "📊"
      },
      {
        "title": "Sin precipitados",
        "body": "Part 1 y Part 2 están diseñadas para mezclarse en el agua sin formar sales insolubles.",
        "emoji": "✦"
      },
      {
      ...
      },
      {
        ...
        "body": "Acompañamiento humano en arranque, ajustes y diagnóstico. Sin call centers.",
        "emoji": "♥"
      },
      {
        "title": "Trazabilidad de lote",
        "body": "Sabés exactamente qué materia prima entró en tu botella.",
        "emoji": "✓"
      }
    ],
    "specs": [
      {
        "label": "Composición",
        "value": "Parte 1: aporta NPK y calcio · Parte 2: aporta magnesio y micro"
      },
      {
        "label": "Forma",
      ...
      },
      {
        ...
        "value": "0.5 a 5 ml/L de cada parte"
      },
      {
        "label": "Dosis floración",
        "value": "2 a 5 ml/L de cada parte"
      },
      {
        "label": "Conservación",
  ...
  "linea-pro": {
    ...
    "features": [
      ...
      {
        "title": "Sin almacenamiento frío",
        "body": "Conservalo donde quieras. No requiere heladera ni rangos estrictos.",
        "emoji": "✦"
      },
      {
      ...
      },
      {
        ...
        "body": "Cada bolsa impresa con lote y composición exacta del análisis.",
        "emoji": "✓"
      }
    ],
    "specs": [
      ...
      {
        "label": "Forma",
        "value": "Sólido cristalino hidrosoluble"
      },
      {
        "label": "Solubilidad",
  ...
  "linea-race": {
    ...
    "features": [
      ...
      {
        "title": "pH ideal",
        "body": "Cada Race trabaja en el rango óptimo del cultivo sin shock de pH.",
        "emoji": "⚖"
      },
      {
        "title": "Estabilidad en mezcla",
        "body": "Fórmulas mezclables sin precipitar, en el orden indicado.",
        "emoji": "✦"
      },
      {
        "title": "Compatible con Elite",
        "body": "Race se puede usar con Elite como booster de floración.",
        "emoji": "↯"
      },
      {
      ...
      {
        "title": "Soporte de uso",
        "body": "Tabla de dosificación clara. Variantes para indoor/outdoor incluidas.",
        "emoji": "♥"
      }
    ],
    "specs": [
      {
        "label": "Composición",
        "value": "Race 1 NPK · Race 2 Ca + N · Race 3 PK (1ª y 2ª parte) · Race 4 Micro + Magnesio"
      },
      {
        "label": "Forma",
        "value": "Líquido concentrado"
  ...
  "bio-estimulante": {
    ...
    "features": [
      {
        "title": "Acelera enraizamiento",
        "body": "Esquejes y plantines arrancan más rápido y con mayor masa radicular.",
        "emoji": "✦"
      },
      {
        "title": "Defensas naturales",
        "body": "Activa la respuesta inmune endógena de la planta sin químicos.",
        "emoji": "♥"
      },
      {
        "title": "Resistencia a estrés",
        "body": "Plantas más tolerantes a transplante, calor, sequía y poda.",
        "emoji": "◆"
      },
      {
        "title": "Mejora absorción",
        "body": "Sinergia con cualquier nutriente — no es un reemplazo, es un potenciador.",
        "emoji": "⚡"
      },
      {
    ...
    "specs": [
      ...
      {
        "label": "Compatibilidad",
        "value": "Todos los productos del catálogo + sustratos minerales"
      },
      {
        "label": "Certificación",
  ...
  "cloner": {
    ...
    "features": [
      ...
      {
        "title": "Espectro amplio",
        "body": "Funciona en esquejes herbáceos, leñosos y semi-leñosos.",
        "emoji": "↯"
      },
      {
        "title": "Combinable con Bio",
        "body": "Aplicar Bio Estimulante en el agua del propagador potencia la respuesta.",
        "emoji": "♥"
      },
      {
        "title": "Trazable",
    ...
    "specs": [
      ...
      {
        "label": "Aplicación",
        "value": "Sumergir base del esqueje 2-3 cm"
      },
      {
        "label": "Tasa típica",
        "value": ">90% en condiciones controladas"
      },
      {
        "label": "Tipo de esquejes",
        "value": "Herbáceos, leñosos, semi-leñosos"
      },
      {
        "label": "Conservación",
        "value": "Bajo techo, 5–25°C, 24 meses"
  ...
  "day-0": {
    ...
    "features": [
      ...
      },
      {
        ...
        "body": "Después de cualquier línea Holistic — Elite, Pro, Race.",
        "emoji": "↯"
      },
      {
    ...
    "specs": [
      ...
      {
        "label": "Dosis",
        "value": "1-2 ml/L según protocolo"
      },
      {
        "label": "Compatibilidad",
        "value": "Cualquier línea Holistic + sustratos minerales"
      },
      {
        "label": "Función",
        "value": "Limpieza de residuos + activación metabolitos"
      },
      {
        "label": "Conservación",
        "value": "Bajo techo, 5–25°C, 24 meses"
