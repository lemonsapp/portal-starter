...
export const productDetails = {
    ...
    "linea-race": {
        ...
        bigStat: {
            ...
            body: "Race 1 (NPK), Race 2 (Calcio + Nitrógeno, Part A + B), Race 3 (PK de crecimiento y maduración, 1ª y 2ª parte) y Race 4 (Micro + Magnesio). Cuatro fertilizantes para el ciclo completo, indoor y outdoor.",
        },
        features: [
        ...
        techSpecs: [
            { label: "Composición",     value: "Race 1 NPK · 2A Ca-Mg · 2B PK · 3A/3B PK crecimiento y maduración · 4 Micro + Magnesio" },
            { label: "Forma",            value: "Líquido concentrado" },
            ...
            { label: "Variantes",        value: "4 fertilizantes para el ciclo completo" },
        ],
    },
